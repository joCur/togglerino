...
import { useIsProjectAdmin, useTemplatesManage } from '../hooks/usePermissions.ts'
...
export default function ProjectLayout() {
  ...
  const canManageTemplates = useTemplatesManage(key)
  ...
  const navLinks = (onNavigate?: () => void) => (
    <>
      ...
      {canManageTemplates && <NavLink to={`/projects/${key}/templates`} className={navLinkClass} onClick={onNavigate}>Templates</NavLink>}
