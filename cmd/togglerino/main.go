...
func main() {
	...
	scheduleChecker := schedule.NewChecker(scheduleStore, flagEnvLookup, pool, schedCacheRefresher, schedBroadcaster, auditStore, flagStore, scheduleStore, 30*time.Second)
